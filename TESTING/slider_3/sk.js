          ...
          var positions = {
              left: function () {
                  var firstSlide = slideController.currentStep.value === 0,
                      lastSlide =
                          slideController.currentStep.value === -steps;
                  ...
                  if (firstSlide) {
                      ...
                      slideController.position.value =
                          slideController.position.value + step;
                      slideController.currentStep.decrease();
                  }
              ...
              right: function () {
                  var firstSlide = slideController.currentStep.value === 0,
                      lastSlide =
                          slideController.currentStep.value === steps - 1;
